...
|      |        | 2025-10-15 | ast, ANF, optimize   | How can nested blocks be unrolled into let-bindings in an AST which is in ANF? |
...
|      |        | 2025-12-26 | tools, ast           | How can an AST be translated to PlantUML or Mermaid and then visualized? |
|      |        | 2025-12-26 | tools, ast           | Is it possible to design a surface language which is also valid PlantUML/Mermaid code, so that the graph is also runnable code? |
|      |        | 2025-12-26 | concurrency          | Can C++ exceptions be used to implement asynchronous functions or even an effects system? |
...
|      |        | 2025-10-15 | lexing               | ~~How can a compact tokenizer be implemented using the nullish coalescing operator?~~ | Already did this in the interpreter |
